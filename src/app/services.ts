...
export const services: Service[] = [
  ...
  { id: "commodity_futures", name: "Commodity Futures Curves", phase: 44, category: "multi-asset", description: "Contango/backwardation signals, roll yields, term structure analysis", commands: ["futures-curve CL", "contango", "roll-yield GC", "term-structure NG"], mcpTool: "get_commodity_futures", params: "action, symbol?, params?", icon: "📊" },
  { id: "crypto_onchain", name: "Crypto On-Chain Analytics", phase: 43, category: "multi-asset", description: "Whale wallet tracking, token flows, DEX volume, gas fee analysis", commands: ["onchain ETH", "whale-watch BTC", "dex-volume", "gas-fees", "token-flows USDT"], mcpTool: "get_crypto_onchain", params: "action, symbol?, params?", icon: "⛓️" },
  { id: "whale_tracking", name: "Whale Tracking", phase: 43, category: "multi-asset", description: "Track large crypto holders (ETH/BTC whales) with balance monitoring", commands: ["whale-watch BTC --min 100", "whale-watch ETH"], mcpTool: "track_whales", params: "chain, min_balance?", icon: "🐋" },
  { id: "dex_volume", name: "DEX Volume", phase: 43, category: "multi-asset", description: "Decentralized exchange volume across protocols via DeFi Llama", commands: ["dex-volume", "dex-volume --protocol uniswap", "dex-volume --chain ethereum"], mcpTool: "get_dex_volume", params: "protocol?, chain?", icon: "🔄" },
  { id: "gas_fees", name: "Gas Fees", phase: 43, category: "multi-asset", description: "Real-time Ethereum gas prices (safe/standard/fast) with USD costs", commands: ["gas-fees"], mcpTool: "get_gas_fees", params: "", icon: "⛽" },
  { id: "token_flows", name: "Token Flows", phase: 43, category: "multi-asset", description: "Track ERC-20 token transfers and whale movements on Ethereum", commands: ["token-flows USDT", "token-flows USDC --hours 24"], mcpTool: "get_token_flows", params: "token, lookback_hours?", icon: "💸" },
  ...
  { id: "fed_policy", name: "Fed Policy Prediction", phase: 45, category: "fixed-income", description: "FOMC analysis, dot plot tracking, rate hike probability scoring via fed funds futures", commands: ["fed-watch", "rate-probability", "fomc-calendar", "dot-plot", "yield-curve", "current-rate"], mcpTool: "get_fed_policy", params: "analysis_type", icon: "🏛️" },
  ...
  { id: "satellite_proxy", name: "Satellite Proxy Analysis", phase: 46, category: "alt-data", description: "Company-specific satellite proxy: Google Trends foot traffic, brand interest correlation with stock momentum", commands: ["satellite-proxy WMT", "satellite-proxy AAPL"], mcpTool: "get_satellite_proxy", params: "ticker", icon: "🛰️" },
  { id: "shipping_index", name: "Shipping Activity Index", phase: 46, category: "alt-data", description: "Baltic Dry Index proxies: shipping stock performance, global trade activity indicators", commands: ["shipping-index"], mcpTool: "get_shipping_index", params: "", icon: "🚢" },
  { id: "construction_activity", name: "Construction Activity", phase: 46, category: "alt-data", description: "Construction employment, building permits, industrial production - leading indicators for materials/industrials", commands: ["construction-activity"], mcpTool: "get_construction_activity", params: "", icon: "🏗️" },
  { id: "foot_traffic", name: "Foot Traffic Proxy", phase: 46, category: "alt-data", description: "Google Trends brand search interest as retail foot traffic proxy", commands: ["foot-traffic AAPL", "foot-traffic WMT"], mcpTool: "get_foot_traffic", params: "ticker", icon: "👟" },
  { id: "economic_index", name: "Economic Activity Index", phase: 46, category: "alt-data", description: "Composite index: construction, shipping, consumer sentiment, retail sales - macro activity scoring", commands: ["economic-index"], mcpTool: "get_economic_index", params: "", icon: "📊" },
  
  // Earnings Call NLP
  { id: "earnings_tone", name: "Earnings Call Tone Analysis", phase: 47, category: "intelligence", description: "Loughran-McDonald sentiment, hedging language detection, tone shift between prepared remarks and Q&A", commands: ["earnings-tone AAPL", "earnings-tone TSLA"], mcpTool: "analyze_earnings_tone", params: "ticker", icon: "🎤" },
  { id: "confidence_score", name: "Management Confidence Score", phase: 47, category: "intelligence", description: "Linguistic markers of confidence, assertive vs hedging language, composite scoring", commands: ["confidence-score AAPL", "confidence-score NVDA"], mcpTool: "get_confidence_score", params: "ticker", icon: "💪" },
  { id: "dodge_detect", name: "Question Dodging Detection", phase: 47, category: "intelligence", description: "Q&A evasiveness analysis, response length vs question complexity, vague answer detection", commands: ["dodge-detect AAPL", "dodge-detect TSLA"], mcpTool: "detect_question_dodging", params: "ticker", icon: "🎯" },
];
