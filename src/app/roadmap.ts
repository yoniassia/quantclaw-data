...
export const additionalPhases = [
  ...
  { id: 680, name: "CDP Carbon Disclosure", description: "Corporate carbon emissions, climate targets. Annual.", status: "done" as const, category: "ESG & Climate", loc: 480 },
  ...
  { id: 696, name: "DTCC Trade Reporting", description: "OTC derivatives volumes, clearing stats. Weekly.", status: "done" as const, category: "Derivatives", loc: 535 },
