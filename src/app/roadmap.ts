...
export const phases: Phase[] = [
  // ============ COMPLETED (1-47) ============
  { id: 1, name: "Core Market Data", description: "Real-time prices, SEC EDGAR filings, news sentiment, caching layer, CLI", status: "done", category: "Foundation", loc: 350 },
  ...
  { id: 578, name: "Carbon Capture Projects", description: "CCS/CCUS project pipeline, capacity. Annual.", status: "done", category: "ESG & Climate", loc: 359 },
  ...
  { id: 580, name: "Drought Monitor Data", description: "US Drought Monitor weekly updates. Weekly.", status: "done", category: "Alternative Data", loc: 365 },
...
export const additionalPhases = [
  ...
  { id: 632, name: "Reserve Bank of India", description: "RBI rates, forex, banking stats. Monthly.", status: "done" as const, category: "Country Stats", loc: 352 },
  ...
  { id: 637, name: "Korea Exchange KRX", description: "KOSPI, KOSDAQ, foreign ownership, short selling. Daily.", status: "done" as const, category: "Exchange Data", loc: 317 },
  ...
  { id: 684, name: "Glassnode On-Chain", description: "Bitcoin/Ethereum UTXO, NVT, SOPR, exchange flows. Daily.", status: "done" as const, category: "FX & Crypto", loc: 472 },
  ...
  { id: 694, name: "BIS Property Prices", description: "Residential/commercial property prices, 60 countries. Quarterly.", status: "done" as const, category: "Global Macro", loc: 283 },
  ...
  { id: 705, name: "CBOE Put/Call & Options Volume", description: "Market-wide put/call ratios, most active options, total equity/index volume. Direct CSV from CBOE. Daily.", status: "done" as const, category: "Derivatives", loc: 298 },
  { id: 706, name: "SEC EDGAR Full-Text Search", description: "Full-text search across all SEC filings. NLP on 10-K/10-Q narratives, keyword alerts. REST API, 10 req/sec, no key. Real-time.", status: "done" as const, category: "Equity", loc: 460 },
  { id: 707, name: "Fed SOMA Holdings", description: "NY Fed System Open Market Account — Treasury/MBS/agency holdings, weekly changes. Direct JSON API, no key. Weekly.", status: "done" as const, category: "Fixed Income", loc: 268 },
  { id: 708, name: "CNN Fear & Greed Index", description: "Composite equity sentiment from 7 indicators: momentum, breadth, put/call, junk demand, VIX, safe haven. Daily.", status: "done" as const, category: "Alt Data", loc: 348 },
  { id: 709, name: "AAII Sentiment Survey", description: "Weekly investor sentiment (bullish/bearish/neutral %). 35+ years history. Classic contrarian indicator. Weekly.", status: "done" as const, category: "Alt Data", loc: 257 },
  { id: 710, name: "Wikipedia Pageviews", description: "Company page views as attention proxy. REST API, no key, generous limits. Daily.", status: "done" as const, category: "Alt Data", loc: 319 },
  { id: 711, name: "OpenFIGI Identifier Mapping", description: "Bloomberg-backed ticker→FIGI/ISIN/CUSIP mapping. Cross-reference infrastructure. 10 req/min, no key. Real-time.", status: "done" as const, category: "Infrastructure", loc: 334 },
  { id: 712, name: "Fed H.15 Interest Rates", description: "Daily selected rates: fed funds, commercial paper, Treasury yields, swaps, SOFR. Direct CSV/XML from Fed. Daily.", status: "done" as const, category: "Fixed Income", loc: 330 },
  { id: 713, name: "Baker Hughes Rig Count", description: "Weekly oil/gas rig count. Leading energy sector indicator. Basin-level breakdown. Direct Excel download. Weekly.", status: "done" as const, category: "Commodities", loc: 253 },
];
...
export const dataSources = [
  ...
  // === NEW: Free No-API-Key Sources (DataScout Feb 2026) ===
  { name: "StockAnalysis.com", icon: "📊", type: "Equity", desc: "EPS revisions, analyst estimates, financials — no API key", status: "pending" as const, modules: ["stockanalysis_eps"] },
  { name: "Finviz", icon: "🔍", type: "Equity", desc: "Stock screener, fundamentals, technicals, insider data", status: "pending" as const, modules: ["finviz_screener"] },
  { name: "OpenInsider", icon: "👔", type: "Equity", desc: "Real-time SEC Form 4 insider trades", status: "pending" as const, modules: ["openinsider"] },
  { name: "ShortVolume.com", icon: "📉", type: "Market Data", desc: "Daily short volume ratios by ticker", status: "pending" as const, modules: ["short_volume"] },
  { name: "FINRA Short Interest", icon: "📋", type: "Market Data", desc: "Official biweekly short interest data", status: "pending" as const, modules: ["finra_short_interest"] },
  { name: "CBOE Options Data", icon: "📈", type: "Derivatives", desc: "Put/call ratios, options volume, VIX data", status: "pending" as const, modules: ["cboe_putcall"] },
  { name: "SEC EDGAR Search", icon: "🔎", type: "Regulatory", desc: "Full-text filing search, keyword alerts", status: "pending" as const, modules: ["edgar_search"] },
  { name: "NY Fed SOMA", icon: "🏦", type: "Fixed Income", desc: "Fed balance sheet holdings, QT tracking", status: "pending" as const, modules: ["fed_soma"] },
  { name: "CNN Fear & Greed", icon: "😱", type: "Sentiment", desc: "7-component equity sentiment composite", status: "pending" as const, modules: ["cnn_fear_greed"] },
  { name: "AAII Sentiment", icon: "📊", type: "Sentiment", desc: "Weekly bull/bear investor sentiment survey", status: "pending" as const, modules: ["aaii_sentiment"] },
  { name: "Wikipedia Pageviews", icon: "📖", type: "Alt Data", desc: "Company attention proxy from page views", status: "pending" as const, modules: ["wiki_pageviews"] },
  { name: "OpenFIGI", icon: "🔗", type: "Infrastructure", desc: "Security identifier mapping (FIGI/ISIN/CUSIP)", status: "pending" as const, modules: ["openfigi"] },
  { name: "Fed H.15 Rates", icon: "💵", type: "Fixed Income", desc: "Daily selected interest rates from the Fed", status: "pending" as const, modules: ["fed_h15"] },
  { name: "Baker Hughes", icon: "🛢️", type: "Commodities", desc: "Weekly oil/gas rig count", status: "pending" as const, modules: ["baker_hughes_rig"] },
];
